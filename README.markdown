...
4. [Setup - The basics of getting started with role_db](#setup)
    * [What role_db affects](#what-role_db-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with role_db](#beginning-with-role_db)
